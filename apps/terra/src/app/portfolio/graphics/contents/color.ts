...
const listColor: tContent[] = [
  {
    name: 'โลกอีกใบ - Cover by IceJi & TangThai',
    year: '2022',
    // tag: ['changing color', 'split tone'],
    img: '/page/portfolio/color/music.jpg',
    link: [{ title: 'watch', url: 'https://youtu.be/BFflEhBnQDg' }],
    description:
  ...
  {
    name: 'Color Test Scene',
    year: '2021',
    // tag: ['tag'],
    img: '/page/portfolio/color/look.jpg',
    link: [
      { title: 'Secondary grading', url: 'https://youtu.be/N5ZaboJkFug' },
      { title: 'Creative look', url: 'https://youtu.be/ToCN3coEmxo' },
    ],
    description:
