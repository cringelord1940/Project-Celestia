...
const list3D: tContent[] = [
  {
    ...
    img: '/page/portfolio/3d/oneForTheRoad.png',
    link: [{ title: 'watch', url: 'https://youtu.be/uyZ2L0SAplY' }],
    description:
  ...
  {
    name: 'AWS Ads (Homework)',
    year: '2022',
    tag: ['MAYA Mash', '3D Animated', 'Arnold Shader', 'Motion Graphics'],
    img: '/page/portfolio/3d/aws.png',
    link: [{ title: 'watch', url: 'https://youtu.be/UI5Mos4nfxw' }],
    description:
  ...
  },
  {
    name: 'Music Studio',
    year: '2021',
    tag: ['Sketchup', 'vRay render', 'Substance Painter'],
    img: '/page/portfolio/3d/musicStudio.jpg',
