...
function CivitLogo({ brandColor }: { brandColor?: boolean }) {
  return (
    <>
      <svg viewBox='0 0 107 22.7' className='h-full w-full fill-inherit'>
        <g>
          <path d='M20.8,1.7H3.7L1.5,4.1v15l2.3,2.3h17.1v-5.2H6.7V7h14.1V1.7z' />
          <path
      ...
      v19.5h7.6l8.3-8.3V1.8h-5.2v8.3l-5.4,6V1.8C36.1,1.8,30.8,1.8,30.8,1.8z M49.1,1.8v19.5h5.2V1.8C54.3,1.8,49.1,1.8,49.1,1.8z'
          />
          <path
            className={clsx(brandColor && 'fill-[#1971c2]')}
      ...
      M92.7,8.9h-8.9V7h8.9V8.9z'
		...
		L10.2,4.7 M10.2,1.6l-8.7,5v10l8.7,5l8.7-5v-10C18.8,6.6,10.2,1.6,10.2,1.6z'
          />
          <path d='M11.8,12.4l-1.7,1l-1.7-1v-1.9l1.7-1l1.7,1h2.1V9.3l-3.8-2.2L6.4,9.3v4.3l3.8,2.2l3.8-2.2v-1.2H11.8z' />
        </g> */}
      </svg>
    </>
  )
